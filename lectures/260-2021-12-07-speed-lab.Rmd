...
- Speed = Distance/Time, then $t=d/s$
...
- Data file with [reaction times](https://docs.google.com/spreadsheets/d/17J7OGYs73tabvn0PQZUKNDRb5DN8roGPIbr1hN0_XOk/edit#gid=0)
...
This document was prepared in RStudio 1.1.717 on `r Sys.time()`.
