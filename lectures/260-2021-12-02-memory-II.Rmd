...
```{r, fig.cap="[[@Dickerson2010-qh]](http://dx.doi.org/10.1038/npp.2009.126)"}
...
```{r, fig.cap="[[@Dickerson2010-qh]](http://dx.doi.org/10.1038/npp.2009.126)", out.height="450px"}
...
- Similar architecture to humans
    - More known about mechnanisms for *spatial* than *non-spatial* memory
